  ...
  return (
      <div className="flex w-full items-center gap-2 p-2 px-4 bg-gray-100 text-sm">
        ...
        >
          ...
          <CircleDot size={18} className={`text-${errLight}-600 `} />
        <button
          onClick={() => handleViewLeft("PDF")}
          className={`${
            leftView == "PDF" ? "text-blue-600" : "text-gray-950"
          } px-3 sm:px-4 py-2 text-xs sm:text-sm whitespace-nowrap flex items-center gap-1 ms-auto`}
        >
          <FileText size={18} />
        </button>
        <button
        ...
        <button
          varient="transparent"
          onClick={() => handleViewLeft("commit")}
          className={`${
            leftView == "commit" ? "text-blue-600" : "text-gray-950"
          } px-3 sm:px-4 py-2 text-xs sm:text-sm whitespace-nowrap flex items-center gap-1`}
        ...
        <button
          varient="transparent"
          onClick={() => handleViewLeft("settings")}
          className={`${
            leftView == "settings" ? "text-blue-600" : "text-gray-950"
          } px-3 sm:px-4 py-2 text-xs sm:text-sm whitespace-nowrap flex items-center gap-1`}
        >
          <Settings size={18} />
        </button>
